					...
					<div class="col-lg-12 col-md-12">
						<div class="white-box">
									...
									<form class="form-horizontal" method="post" action="<?php echo base_url() ?>back/eksperimen/edit_aksi">
										...
										<div class="form-group">
										<label for="gejala" class="col-sm-4">Nama Pelajaran</label>
										<div class="col-sm-4">
										...
										<div class="form-group">
			                              ...
			                              <div class="col-sm-4">
			                                  <input type="number" placeholder="1" step="1" min="1" max="" name="sesi" class="form-control" value="<?php echo $list['sesi'];?>" />
			                              </div>
		                              	</div>
