                        ...
                        <div class="white-box">
                            ...
                            foreach($jadwal as $list) { ?>
                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>back/jadwal/edit_aksi">
                                        ...
                                        <div class="form-group">
                                        <label for="" class="col-sm-4">Waktu Mulai</label>
                                        <div class="col-sm-4">
                                        <input type="time" name="jam_mulai" class="form-control" value="<?php echo $list['jam_mulai']; ?>" />
                                        </div>
                                        </div>

                                        <div class="form-group">
                                        <label for="" class="col-sm-4">Waktu Selesai</label>
                                        <div class="col-sm-4">
                                        <input type="time" name="jam_selesai" class="form-control" value="<?php echo $list['jam_selesai']; ?>" />
                                        </div>
                                        </div>
