    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="<?php echo base_url() ?>back/home_back"><b><img src="<?php echo base_url() ?>asset/back/plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>Nilai</strong> Praktikum</span></a></div>
